...
texan_vacay_1 = Leg.create(location: houston, trip: texan_vacay)
texan_vacay_2 = Leg.create(location: austin, trip: texan_vacay)
texan_vacay_3 = Leg.create(location: dallas, trip: texan_vacay)

actors_delight_1 = Leg.create(location: dc, trip: actors_delight)
actors_delight_2 = Leg.create(location: charleston, trip: actors_delight)
actors_delight_3 = Leg.create(location: ny, trip: actors_delight)

euro_trip_1 = Leg.create(location: paris, trip: euro_trip)
euro_trip_2 = Leg.create(location: london, trip: euro_trip)
euro_trip_3 = Leg.create(location: rome, trip: euro_trip)
...
whattaburger = Expense.create(cost:30.50, description:"Lunch at whattaburger", category: food, leg: texan_vacay_1)
rodeo = Expense.create(cost:112, description:"Rodeo night show", category: activities, leg: texan_vacay_2)
barn = Expense.create(cost:400, description:"Hotel stay at the Barn", category: housing, leg: texan_vacay_3) 

sad_happy_masks = Expense.create(cost:44.99, description:"Sad face, happy face wall decor", category: shopping, leg: actors_delight_1)
improv_class = Expense.create(cost:432, description:"Week long improv class", category: activities, leg: actors_delight_2)
mcdonalds = Expense.create(cost:12, description:"McDonalds dinner", category: food, leg: actors_delight_3)

wine = Expense.create(cost:19.99, description:"White wine bottle as gift for boyfriend", category: shopping, leg: euro_trip_1)
pasta = Expense.create(cost:49.59, description:"Dinner at pasta place", category: food, leg: euro_trip_2)
bungee_jumping = Expense.create(cost:49.59, description:"Bungee jumping from the colleseum - bad call", category: food, leg: euro_trip_3)
